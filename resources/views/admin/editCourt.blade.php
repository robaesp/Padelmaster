...
@section('titulo')
Admin-Editar Pista: {{ $courts->id}}
@endsection

@section('contenido')
<div class="md:flex md:justify-center">
    <div class="md:w-1/2 bg:white shadow p-6">
        <form method="POST" action="{{route('admin.editCourt', $courts->id )}}" enctype="multipart/form-data" class="mt-10 md:mt-0">
            @method('PUT')
            @csrf
            <div class="mb-5">
                ...
                <div class="mb-5">
                        <label for="city" class="mb-2 block uppercase text-gray-500 font-bold">
                            ...
                            <input
                                ...
                                name="city"
                                type="text"
                                placeholder="Escoge una nueva ciudad"
                                class="border p-3 w-full rounded-lg"
                                />
                    </div>
